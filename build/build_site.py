...
@media (max-width:600px){body{font-size:17px}.hero{padding:40px 0 16px}.grid{grid-template-columns:1fr}.reader{padding:32px 20px 60px 20px}.reader.story{padding:32px 20px 60px 20px}[data-theme="zesty"] .reader,[data-theme="zesty"] .reader.story{padding:32px 20px 60px 20px}.prose{font-size:1.08rem;line-height:1.9}.reader.story .prose{font-size:1.08rem;line-height:1.9}.reader h1{font-size:1.65rem}}
