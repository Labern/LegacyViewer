...
.prose{font-size:1.16rem;line-height:1.85}
...
@media (max-width:600px){body{font-size:17px}.hero{padding:40px 0 16px}.grid{grid-template-columns:1fr}}
</style>
</head>
<body>
...
<main id="home">
  ...
  <footer class="site"><div class="wrap">
    &copy; Luke Labern, 2008&ndash;2024 &middot; __N__ works &middot; A static, database-free archive &middot; everything here is searchable and clickable.
  </div></footer>
</main>
...
function renderBrowse(){
  ...
  const tagCounts={}; WORKS.forEach(w=>(w.g||[]).forEach(g=>tagCounts[g]=(tagCounts[g]||0)+1));
